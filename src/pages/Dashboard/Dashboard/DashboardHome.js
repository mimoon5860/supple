          ...
          {admin ? (
            <Paper elevation={0}>
              ...
              <p>
                ...
                website. Admins can add content on all pages and access all
                items in the Admin Toolbar. This means that Admins can control
                site-wide settings like the design of your website and the
                homepage layout. They can add and delete other admin users, and
                can approve or deny edits made by authors.
              </p>
            ...
            <Paper elevation={0}>
              ...
              <p>
                ...
                times. Now the times begin to start shopping. let's go ------
              </p>
